...
Save figure 1 to `FOLDER NAME` project folder: 
...
Save figure 2 to `FOLDER NAME` project folder: 
...
Save figure 3 to `FOLDER NAME` project folder: 
...
Save appendix 1 to `FOLDER NAME` project folder: 
...
Save appendix 2 to `FOLDER NAME` project folder: 
...
Save appendix 3 to `FOLDER NAME` project folder: 
...
EXTRACT FROM .BIB (LINE 3418 IN REVISIONS) - EXTRACT TITLE, MERGE ALL TOGETHER, CREATE FULL TABLE

#merge titles with citation info and rest of a4 info
```
...
df_list_long <- map(a4_dflist, ~ .x %>% 
                      ...
                      mutate(variable = case_when(variable == "review_author_year" ~ "Review",
                                                  variable == "review_eligibility_participants" ~ "Eligibility Criteria: Participants",
                                                  variable == "review_eligibility_interventions" ~ "Eligibility Criteria: Interventions",
                                                  variable == "review_eligibility_comparisons" ~ "Eligibility Criteria: Comparisons",
                                                  variable == "review_eligibility_outcomes" ~ "Eligibility Criteria: Outcomes",
                                                  variable == "review_eligibility_timing" ~ "Eligibility Criteria: Timing",
                                                  variable == "review_eligibility_setting" ~ "Eligibility Criteria: Setting",
                                                  variable == "review_eligibility_studies" ~ "Eligibility Criteria: Studies",
...
Save appendix 4 to `FOLDER NAME` project folder: 

```{r a4-save}
#save as HMTL
writeLines(html_code, "test_breaks.html")
