...
png(here("report", "figures", "f2_heatmap.png"), width = 1000, height = 1000)
...
```{r save-f3}
#set image dimensions and file path to save
png(here("report", "figures", "f3_heatmap.png"), width = 1000, height = 1000)
...
pdf(here("report", "figures", "f4_forestplot.pdf"), width = 20, height = 15)
